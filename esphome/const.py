...
CONF_CONTROL_ACTION = 'control_action'
CONF_ERROR_VALUE_ACTION = 'error_value_action'
CONF_HAS_CURRENT_TEMPERATURE = 'has_current_temperature'
CONF_TARGET_TEMPERATURE_LAMBDA = 'target_temperature_lambda'
CONF_MODES = 'modes'
CONF_MODE_LAMBDA = 'mode_lambda'
CONF_COLD = 'cold'
